        ...
        <section className="relative h-[70vh] min-h-162 overflow-hidden">
            ...
            <div className="relative z-10 max-w-330 mx-auto flex h-full items-center px-3">
                ...
                >
                    ...
                    <p className="mb-8 text-lg leading-7 playfair  text-gray-200">
                        Explore beautiful room inspirations, save your favorite designs,
                        and let AI create personalized interiors based on your style,
